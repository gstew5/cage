...
Ltac crush' lemmas invOne again :=
    ...
    repeat (match goal with
              | [ H : ?P |- _ ] =>
                match P with
                  ...
                  | _ => erewrite H by crush' lemmas invOne true
                end
  ...
  (** Now the main sequence of heuristics: *)
    (sintuition; rewriter;
      ...
      try autounfold with *; try (repeat red);  sintuition; rewriter; sintuition;
