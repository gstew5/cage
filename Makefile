...
Makefile.conf: 
	coq_makefile ccombinators.v cdist.v christodoulou.v client.v combinators.v compile.v depfinfun.v dynamics.v games.v lightserver.v loadbalancing2.v loadbalancing.v lp.v machine.v orderedtypes.v potential.v routing1.v routing2.v routing_gen.v routing.v server.v smooth.v staging.v subsettypes.v vc.v winnow.v -o Makefile
