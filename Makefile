...
# coq_makefile axioms.v bigops.v christodoulou.v combinators.v compile.v dist.v dynamics.v extrema.v games.v neps_exp_le.v numerics.v potential.v smooth.v weightslang.v weights.v -I . 
#
